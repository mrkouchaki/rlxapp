...
setup(
    ...
    description="Central Critic for Multi-Agent Federated Actors",
    url="https://github.com/mrkouchaki/cxapp2",
    ...
    entry_points={"console_scripts": ["run-mr.py=cxapp.main:start"]},  # adds a magical entrypoint for Docker
    license="Apache 2.0",
